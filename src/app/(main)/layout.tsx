...
function Sidebar() {
    ...
    const agents = [
        { id: 'Blog', name: 'Blog', role: '바른모양치과 전문 라이터', icon: FileText, desc: '임플란트/교정 전문 칼럼 및 블로그 컨텐츠 제작' },
        { id: 'Insta', name: 'Insta', role: '치과 비주얼 디렉터', icon: Instagram, desc: '내원객 모집/병원 전경 중심의 카드뉴스 기획 및 프롬프트 생성' },
        { id: 'Shortform', name: 'Shortform', role: '원테이크 디렉터', icon: Play, desc: '유튜브 쇼츠/인스타 릴스용 15초 원테이크 대본 기획' },
        { id: 'Threads', name: 'Threads', role: '인사이트 디렉터', icon: AtSign, desc: '의료적 통찰을 담은 짧고 날카로운 스레드 타래 작성' },
        { id: 'Dang', name: 'Dang', role: '지역 커뮤니티 홍보 매니저', icon: Share2, desc: '지역 환자/내원객 커뮤니티(당근마켓) 홍보 및 소통' },
        { id: 'Supporter', name: 'Supporter', role: '환자/내원객 상담 실장', icon: MessageSquare, desc: '카카오톡 등 환자/내원객 진료/상담 문의 응대 스크립트 작성' },
        { id: 'Reputation', name: 'Reputation', role: '진료 후기 관리자', icon: ShieldAlert, desc: '치과/진료 리뷰에 대한 맞춤형 답변 생성' },
        { id: 'Marketer', name: 'Marketer', role: '전략가 + 감시관', icon: TrendingUp, desc: '경쟁 치과 동향 분석 및 의료법/광고법 리스크 감시' },
    ];
        ...
        >
            ...
            <div className="p-6 border-b border-sand/30 flex justify-between items-center">
                <button
                    ...
                    title="새로고침 (초기화)"
                >
                    <h1 className="text-2xl font-serif font-bold text-secondary">바른모양치과 마케팅 OS</h1>
